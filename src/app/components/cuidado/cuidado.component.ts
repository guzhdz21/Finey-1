...
testFinalizado(){
  ...
  if(this.respuestasContestadas[0][1] == 1 && this.respuestasContestadas[0][2] == 1){
    ...
    this.accionesService.presentAlertGenerica("Consejos de limpieza de cuidado personal", consejo4 + consejo1 + consejo2 + consejo3);    
  }
  ...
  var justificado = true;
    ...
    if(justificado){
      this.accionesService.presentAlertGenerica("Gasto ropa justificado", "Aunque tu gasto este arriba de la media nacional" +
