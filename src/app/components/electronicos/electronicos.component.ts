...
export class ElectronicosComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.radioRequired[0][6] = true;
    this.radioRequired[0][7] = true;
    this.radioRequired[0][8] = true;
...
testTelevision(){
      ...
      if(justificado1 == true){
        this.accionesService.presentAlertGenerica("Gasto de Televisión justificado", "Aunque tu gasto este arriba de la media nacional" +
        ", está justificado, pues si lo aprovechas bien o simplemente lo necesitas tal y como es debido a tus respuestas");
      }
      else{
